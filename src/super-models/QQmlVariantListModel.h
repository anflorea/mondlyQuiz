...
#define QML_VARIANTLIST_PROPERTY(type, name) \
    protected: Q_PROPERTY (QQmlVariantListModelBase * name READ get_##name CONSTANT) \
    private: QQmlVariantListModel<type> * m_##name; \
    public: QQmlVariantListModel<type> * get_##name (void) const { return m_##name; } \
    private:
